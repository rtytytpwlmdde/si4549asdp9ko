...
?>
    ...
    <div class="col ">
        ...
        <div class="row  py-2">
            ...
            <a hidden class="mb-2 btn btn-sm btn-outline-primary mr-1" style="max-width:100px" href="<?php echo base_url('Pdfs/save_pdf_peminjaman/'.$a->id_peminjaman_rutin.'/rutin') ?>"> <i class="material-icons">print</i> Print </a>   
            <?php } ?>
            </div>
        </div>
        </div>
