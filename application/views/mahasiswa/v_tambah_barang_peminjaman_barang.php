...
<div class="row">
            ...
            <div class='card-body p-0'>
                ...
                <div class="table-striped" style="overflow-x:auto; ">
                    ...
                    <td><?php echo $no++ ?></td>
                            ...
                            <?php 
                            if($r->status == "pending"){ ?>
                                <a href="<?php echo site_url('mahasiswa/hapus_barang_peminjaman_barang/'.$u->id_peminjaman_barang.'/'.$u->id_detail_peminjaman_barang); ?>"  type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus">
    ...
    <div class="col-lg-4 col-md-12">
        ...
        <div class='card-body p-0'>
            ...
            <form action="<?php echo base_url(). 'mahasiswa/tambahBarangPeminjamanBarang/'; ?>" method="post">
            ...
            <?php }else{?>
                <a  href="<?php echo site_url('mahasiswa/ubah_status_peminjaman_barang/'.$u->id_peminjaman_barang.'/'.$u->id_peminjam);?>" class="mb-2 btn btn-sm btn-primary mr-1"><info class="text-warning">Selesai</info></a>
            <?php }?>
            <?php }else{ ?>
