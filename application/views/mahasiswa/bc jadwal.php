<div class="main-content-container container-fluid">
                  ...
                  <div class="page-header row no-gutters py-4">
                    ...
                    <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
                    <form action="<?php echo site_url('mahasiswa/filter_jadwal_plot');?>"  method="get" style="float:right" >
                                ...
                                <tr>
                                    ...
                                    foreach ($peminjaman_rutin as $u){
                                        ...
                                        >
                                            ...
                                            <h6 class="text-white" style="font-size:12px;"><?php foreach ($dosen as $a){if ($a->NIP == $u->id_dosen) :echo substr($a->Nama,0,40);endif;}  ?><br>
                                            <?php echo "Kelas - ".$u->kelas;?>
                                            </h6>
                                            <?php 
