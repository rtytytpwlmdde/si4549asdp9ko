...
?>
    ...
    <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
        ...
        <h3 class="page-title">Ruangan Khusus</h3>
    </div>
    <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
    </div>
</div>
...
<div class="row">
    <div class="col-lg-9 col-md-12">
        ...
        <div class="alert alert-accent alert-dismissible fade show mb-3" role="alert">
                ...
                <strong class="text-white">Perhatian! <br>
                Peminjaman ini bersifat khusus, digunakan jika ingin meminjam ruangan khusus yang harus validasi oleh WD3 </br>  </strong>
            </div>
            <div class="alert alert-accent alert-dismissible fade show mb-3" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                </button>
                <strong class="text-white">
                Halaman ini hanya untuk mengisi biodata peminjam. Ruangan dapat ditambahkan di halaman berikutnya, yakni setelah menekan tombol  </strong>  <strong class="text-warning">next</strong> 
            </div>

            <form action="<?php echo base_url(). 'mahasiswa/tambahPeminjamanKhusus'; ?>" method="post">
                <div class="form-row">
