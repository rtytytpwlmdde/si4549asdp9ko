<div class="main-content-container container-fluid">
                  ...
                  <div class="page-header row no-gutters py-2">
                    ...
                    <form action="<?php echo site_url('mahasiswa/filter_peta_ruangan_non_rutin');?>"  method="get" style="float:right" >
                      ...
                      <div class=" alert alert-accent alert-dismissible fade show mb-3" role="alert">
                        ...
                        <table class="table table-bordered" id="pegawai" >
                            ...
                            <?php 
                                ...
                                <tr>
                                    <th class="text-sm-left"><?php echo $r->ruangan?>  </th>
                                    <?php for ($x = 7; $x <= 22; $x++) {
                                    ...
                                    $waktu = $x;
                                    ?>
                                    <th class="text-sm-center" style="max-width:100px;">
