...
<div class="row">
            ...
            <div class='card-body p-0'>
                ...
                <div class="table-striped" style="overflow-x:auto; ">
                    ...
                    <td><?php echo $no++ ?></td>
                            ...
                            <?php 
                            if($r->status == "pending"){ ?>
                                <a href="<?php echo site_url('mahasiswa/hapus_ruangan_peminjaman_khusus/'.$u->id_peminjaman_non_rutin."/".$u->id_ruangan); ?>"  type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus">
    ...
    <div class="col-lg-4 col-md-12">
        ...
        <div class='card-body p-0'>
            ...
            <form action="<?php echo base_url(). 'mahasiswa/tambahRuanganPeminjamanKhusus/'; ?>" method="post">
            ...
            <input hidden name="id_peminjam" type="date" class="form-control" value="<?php echo $u->id_peminjam;?>" > 
            ...
            <?php }else{?>
                <a  href="<?php echo site_url('mahasiswa/ubah_status_peminjaman_barang/'.$u->id_peminjaman_non_rutin.'/'.$u->id_peminjam);?>" class="mb-2 btn btn-sm btn-primary mr-1"><info class="text-warning">Selesai</info></a>
            <?php }?>
