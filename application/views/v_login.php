      ...
      <div class="row h-100">
		...
		?>
            <div class="row no-gutters h-100 ">
              ...
              <div class="col-lg-6 col-md-6 auth-form mx-auto my-auto bg-light">
                <div class="px-4 py-4">
                  <div class="login_form">
                    ...
                    <form action="<?php echo base_url().'auth/cek_login'; ?>" method="post">
                      <div class="form-group">
                        ...
                        <input class="form-control" id="exampleInputEmail1" placeholder="Username" name="username" type="text"  > </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Password</label>
                        <input class="form-control" id="exampleInputPassword1" placeholder="Password" name="password" type="password"> </div>
                     
                      <button type="submit" class="btn btn-pill btn-accent d-table mx-auto">Sign In</button>
                    </form>
                  </div><br>
