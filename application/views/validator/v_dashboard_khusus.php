            ...
            <div class="col-lg-8 col-md-12 col-sm-12 mb-4">
                <div class="card card-small">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">Grafik Peminjaman Khusus</h6>
                  </div>
                  ...
                  <div class="row border-bottom py-2 bg-light">
                    ...
                    <?php 
                            $no = 1;
                            foreach($tot_peminjaman_khusus_by_year as $u){
                  ...
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        ...
                        <h6 class="stats-small__value count my-3"><?php foreach($peminjaman_khusus as $a){ echo $a['count_peminjaman_khusus']; }?></h6>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        ...
                        <h6 class="stats-small__value count my-3"><?php foreach($peminjaman_khusus_setuju as $a){ echo $a['count_peminjaman_khusus_setuju']; }?></h6>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        ...
                        <h6 class="stats-small__value count my-3"><?php foreach($peminjaman_khusus_tolak as $a){ echo $a['count_peminjaman_khusus_tolak']; }?></h6>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        ...
                        <h6 class="stats-small__value count my-3"><?php foreach($peminjaman_khusus_terkirim as $a){ echo $a['count_peminjaman_khusus_terkirim']; }?></h6>
                      </div>
                    </div>
                  </div>
                </div>
