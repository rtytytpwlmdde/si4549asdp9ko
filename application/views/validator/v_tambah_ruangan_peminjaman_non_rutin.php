...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <div class="mb-3">
        <div class="">
            <p class="mb-4">Data Peminjaman Non Rutin </p>
            ...
            <div class='card-body p-0'>
                ...
                <div class="table-striped" style="overflow-x:auto; ">
                    ...
                    <td><?php echo $no++ ?></td>
                            ...
                            <?php 
                            if($r->status == "pending"){ ?>
                                <a href="<?php echo site_url('validator/hapus_ruangan_peminjaman_non_rutin/'.$u->id_peminjaman_non_rutin."/".$u->id_ruangan); ?>"  type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus">
    ...
    <div class="col-lg-4 col-md-12">
        ...
        <div class='card-body p-0'>
            ...
            <form action="<?php echo base_url(). 'validator/tambahRuanganPeminjamanNonRutin/'; ?>" method="post">
            ...
            <?php }else if($no != 1){?>
            <a  href="<?php echo site_url('validator/ubah_status_peminjaman_non_rutin/1/'.$u->id_peminjaman_non_rutin.'/'.$u->id_peminjam);?>" class="mb-2 btn btn-sm btn-primary mr-1"><info class="text-warning">Selesai</info></a>
            <?php }?>
            <?php }else{ ?>
