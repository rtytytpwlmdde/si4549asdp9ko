<div class="main-content-container container-fluid">
                  ...
                  <div class="page-header row no-gutters py-2">
                    <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
                        <h3 class="page-title">Pemetaan Ruangan Kelas</h3>
                    </div>
                    <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
                    ...
                    <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
                    <form action="<?php echo site_url('validator/filter_peta_ruangan');?>"  method="get" style="float:right" >
                ...
                <div class=" mb-4">
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-3">
                      <div class="row">
                        <div class="col">
                          <form action="<?php echo base_url(). 'validator/tambahPeminjamanRutin'; ?>" method="POST">
                          ...
                          <div class="form-group">
                              ...
                              <input  disabled name="se" type="text"  class="form-control" id="feInputAddress" value="<?php echo $this->session->userdata('username') ?>"> 
                              <input  hidden name="id_peminjam" type="text"  class="form-control" id="feInputAddress" value="<?php echo $this->session->userdata('username') ?>">  
                            </div>
                          <div class="form-row">
                         ...
                         <div class="form-group">
                            ...
                            <input  class="form-control" name="kode_matkul" list="matkul">
                              <datalist id="matkul">
                            ...
                            <input  class="form-control" name="id_dosen" list="dosen">
                              <datalist id="dosen">
