...
<div class="row">
        ...
        <div class="">
            ...
            <div class="main-content-container ">
                ...
                <?php 
                    ...
                    ?>
                <tr>
                        <td><?php echo $u->id_peminjaman_barang;?></td>
            ...
            <div class='card-body p-0'>
                ...
                <div class="table-striped" style="overflow-x:auto; ">
                    ...
                    <td><?php echo $no++ ?></td>
                            ...
                            <?php 
                            if($r->status == "pending"){ ?>
                                <a href="<?php echo site_url('validator/hapus_barang_peminjaman_barang/'.$u->id_peminjaman_barang.'/'.$u->id_detail_peminjaman_barang); ?>"  type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus">
    ...
    <div class="col-lg-4 col-md-12">
        ...
        <div class='card-body p-0'>
            ...
            <form action="<?php echo base_url(). 'validator/tambahBarangPeminjamanBarang/'; ?>" method="post">
            ...
            <?php }else{?>
                <a  href="<?php echo site_url('validator/ubah_status_peminjaman_barang/'.$u->id_peminjaman_barang.'/'.$u->id_peminjam);?>" class="mb-2 btn btn-sm btn-primary mr-1"><info class="text-warning">Selesai</info></a>
            <?php }?>
            <?php }else{ ?>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#kategori').change(function(){
			var id=$(this).val();
			$.ajax({
				url : "<?php echo base_url();?>/validator/get_subkategori",
				method : "POST",
				data : {id: id},
				async : false,
		        dataType : 'json',
