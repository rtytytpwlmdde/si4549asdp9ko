            ...
            <div class="col-lg-8 col-md-12 col-sm-12 mb-4">
                <div class="card card-small">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">Grafik Peminjaman Sarpras</h6>
                  </div>
                  ...
                  <div class="row border-bottom py-2 bg-light">
                    ...
                    <?php 
                            $no = 1;
                            foreach($tot_peminjaman_barang_by_year as $u){
                  ...
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase">Peminjaman Sarpras</span>
              ...
              <div class="col-lg col-md-6 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase">Peminjaman Sarpras Setuju</span>
                        <h6 class="stats-small__value count my-3"><?php foreach($peminjaman_barang_setuju as $a){ echo $a['count_peminjaman_barang_setuju']; }?></h6>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg col-md-6 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase">Peminjaman Sarpras Tolak</span>
                        <h6 class="stats-small__value count my-3"><?php foreach($peminjaman_barang_tolak as $a){ echo $a['count_peminjaman_barang_tolak']; }?></h6>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg col-md-6 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase">Peminjaman Sarpras Terkirim</span>
                        <h6 class="stats-small__value count my-3"><?php foreach($peminjaman_barang_terkirim as $a){ echo $a['count_peminjaman_barang_terkirim']; }?></h6>
                      </div>
                    </div>
                  </div>
                </div>
