                    ...
                    <li class="list-group-item p-3">
                      <div class="row">
                        ...
                        <?php foreach($user as $u): ?>
                          <form action="<?php echo base_url(). 'validator/update_password'; ?>" method="POST">
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feEmailAddress">Password lama</label>
                                <input required name="password_lama"  title="Gunakan kombinasi huruf dan angka, 5-16 karakter" type="password" class="form-control" id="feEmailAddress" placeholder="Password Lama"> 
                            </div>
                              <div class="form-group col-md-6">
