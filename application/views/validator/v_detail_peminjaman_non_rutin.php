    ...
    <div class="col ">
        ...
        <div class="row border-bottom  py-2">
            <div class="col-sm-3 text-center text-sm-left mb-0">
                <h6 class="m-0 py-1">Detail Peminjaman Non Kelas</h6>
            </div>
        ...
        <div class=" pt-0 py-1">
            ...
            <div class="main-content-container ">
                ...
                <table class="table table-bordered table-hover  " id="pegawai">
                    <tbody>
                    <?php foreach ($peminjaman_non_rutin as $pnr){?>
                    <tr>
                        <td>Kode Booking </td>
                    ...
                    <tr>
                        ...
                        if (strlen($pnr->jam_mulai_peminjaman) == 1){
                                ...
                                if (strlen($pnr->jam_selesai_peminjaman) == 1){
                                    echo "0".$pnr->jam_selesai_peminjaman.":59"; 
                                }else{
                                    echo $pnr->jam_selesai_peminjaman.":59"; 
                                } 
                                    ?>
                        </td>
                    </tr>
                    <tr>
                        <td>Ruangan</td>
                        <td> <?php foreach ($ruangan_non_rutin as $a){ echo $a->ruangan ?> <br><?php }  ?></td>
                    </tr>
                    <tr>
                        <td>Keterangan</td>
                    ...
                    <tr>
                        <td>Catatan Penlolakan</td>
                            <td><?php echo $pnr->catatan_penolakan ?></td> <?php }?>
                    </tr>
