...
<html class="no-js h-100" lang="en">
  ...
  <a class="navbar-brand text-white" href="<?php echo base_url('mahasiswa/peta_jadwal_kuliah'); ?>" style="line-height: 29px;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto px-3">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<?php echo base_url('mahasiswa/peta_ruangan'); ?>">Kelas</a>
          <a class="dropdown-item" href="<?php echo base_url('mahasiswa/peta_ruangan_non_rutin'); ?>">Non Kelas</a>
          <a class="dropdown-item" href="<?php echo base_url('mahasiswa/peta_sarpras'); ?>">Sarana Prasarana</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<?php echo base_url('mahasiswa/peta_ruangan'); ?>">Kelas</a>
          <a class="dropdown-item" href="<?php echo base_url('mahasiswa/inputPeminjamanNonRutin'); ?>">Non Kelas</a>
          <a class="dropdown-item" href="<?php echo base_url('mahasiswa/inputPeminjamanBarang'); ?>">Sarana Prasarana</a>
          <a hidden class="dropdown-item" href="<?php echo base_url('mahasiswa/inputPeminjamanKhusus'); ?>">Ruangan Khusus</a>
        </div>
      </li>
      <li class="nav-item active">
          <a href="<?php echo base_url('mahasiswa/history_peminjaman/'.$this->session->userdata('id_login')); ?>" class="nav-link  text-white"><i class="material-icons">access_time</i> History Peminjaman</a>
        </li>
    </ul>
