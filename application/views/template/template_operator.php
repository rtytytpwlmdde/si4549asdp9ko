        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          <div class="main-navbar">
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="<?php echo base_url('operator/index'); ?>" style="line-height: 25px;">
            ...
            <ul class="nav nav--no-borders flex-column">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-small">
                  <a class="dropdown-item " href="<?php echo base_url('operator/peta_jadwal_kuliah'); ?>">Jadwal Kuliah</a>
                  <a class="dropdown-item " href="<?php echo base_url('operator/list_agenda_umum'); ?>">Agenda Umum</a>
                  <a class="dropdown-item " href="<?php echo base_url('operator/list_agenda_akademik'); ?>">Agenda Akademik</a>
                </div>
              </li>
            </ul>
            <ul class="nav nav--no-borders flex-column">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-small">
                  <a hidden class="dropdown-item " href="<?php echo base_url('operator/user'); ?>">User</a>
                  <a class="dropdown-item " href="<?php echo base_url('operator/data_pegawai'); ?>">Pegawai</a>
                  <a hidden  class="dropdown-item " href="<?php echo base_url('operator/mahasiswa'); ?>">Mahasiswa</a>
				  <a class="dropdown-item " href="<?php echo base_url('operator/pencarian'); ?>">Mahasiswa</a>
                </div>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle " data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="true">
                ...
                <div class="dropdown-menu dropdown-menu-small">
                  <a class="dropdown-item " href="<?php echo base_url('operator/rekap_jadwal_rutin'); ?>">Rekap Jadwal Pengganti</a>
                  <a hidden class="dropdown-item " href="<?php echo base_url('operator/rekap_peminjaman'); ?>">Rekap Peminjaman</a>
                  <a class="dropdown-item " href="<?php echo base_url('operator/rekap_peminjam_pegawai'); ?>">Rekap Peminjam</a>
				   <a class="dropdown-item " href="<?php echo base_url('operator/rekap_peminjaman_barang'); ?>">Rekap Peminjaman Barang</a>
				  <a class="dropdown-item " href="<?php echo base_url('operator/pencarian_peminjam'); ?>">Pencarian Rekap Peminjaman</a>
                   </div>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle " data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="true">
                ...
                <div class="dropdown-menu dropdown-menu-small">
                  <a class="dropdown-item " href="<?php echo base_url('operator/semester'); ?>">Setting Semester</a>
                  <a class="dropdown-item " href="<?php echo base_url('operator/ruangan'); ?>">Kelas / Ruangan </a>
                  <a class="dropdown-item " href="<?php echo base_url('operator/matakuliah'); ?>">Mata Kuliah</a>
				...
				<li class="nav-item">
				<a class="nav-link " href="<?php echo base_url('operator/reset_password'); ?>">
            ...
            <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
              ...
              <ul class="navbar-nav  flex-row ">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item " href="<?php echo base_url('operator/profil/'.$this->session->userdata('username')) ?>">
