  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto px-3">
      <li class="nav-item active">
        <a class="nav-link text-white" href="<?php echo base_url('mahasiswa/peta_jadwal_kuliah'); ?>"><i class="material-icons">toc</i> Home</a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="<?php echo base_url('auth/login'); ?>">Ruangan Khusus</a>
        </div>
      </li>
      <li class="nav-item active">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
          <a href="<?php echo base_url('auth/login'); ?>" class="nav-link  text-white"> Log in</a>
        </li>
      </ul>
  </div>
</nav>
