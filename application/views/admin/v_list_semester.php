...
?>
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a  href="<?php  echo base_url('admin/inputSemester'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
        ...
        <div class=" pt-0">
            ...
            <div class="main-content-container ">
                ...
                <tbody>
                    ...
                    <td><a href="<?php echo site_url('admin/jadwal_kuliah/'.$u->id_semester); ?>"><?php echo $u->semester ?></a></td>
                    ...
                    <td class="sorting_1" style="">
                        <a href="<?php echo site_url('admin/updateSemester/'.$u->id_semester); ?>" type="button" class="btn btn-white" title="Edit">
                            <i class="material-icons">edit</i>
                        </a>
                        <a href="<?php echo site_url('admin/hapusSemester/'.$u->id_semester); ?>" type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus">
