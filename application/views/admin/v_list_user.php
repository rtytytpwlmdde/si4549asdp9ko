...
?>
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
            ...
            <h3 class="page-title">Semua User</h3>
        </div>
        <div class="col-12 col-sm-4 d-flex align-items-center">
        <div hidden class="btn-group btn-group-sm btn-group-toggle d-inline-flex mb-4 mb-sm-0 mx-auto" role="group" aria-label="Page actions">
          <a hidden href="<?php echo base_url('admin/data_dosen'); ?>" class="btn btn-white" title="Tampilkan hanya data dosen"> Rutin </a>
          <a hidden href="#" class="btn btn-white active" title="Tampilkan semua data pegawai"> Semua </a>
          <a hidden href="<?php echo base_url('admin/data_staff'); ?>" class="btn btn-white" title="Tampilkan hanya data staff"> Non Rutin </a>
        </div>
      </div>
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
        <div  style="float:right" >
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a  href="<?php  echo base_url('admin/inputUser'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
                <i class="material-icons">add</i>Tambah
            </a>      
            <a  href="<?php  echo base_url('admin/import_pegawai'); ?>" type="submit" class="form-control btn btn-primary text-center text-white" style="float:center">
    ...
    <div class="col ">
        ...
        <div class="row border-bottom  py-2">
            <div class="col-sm-3 text-center text-sm-left mb-0">
                <h6 class="m-0">Tabel Data User</h6>
            </div>
        ...
        <div class=" pt-0">
            ...
            <div class="main-content-container ">
                ...
                <tr>
					...
					<th scope="col" class="">Hak Akses Gedung</th>
                ...
                <td><?php echo $no++ ?></td>
                        <td><?php
							if($u->status == 'validator_non_rutin'){?>
							<a href="<?php echo site_url('admin/hak_akses/'.$u->username); ?>">
							<?php }else{?>
									<a href="#">
							<?php } ?>
						<?php echo $u->username ?></td>
                        <td><?php echo $u->password ?></td>
                        <td><?php echo $u->status ?></td>
						<td><?php if($u->status == 'validator_non_rutin'){ 
                                    foreach ($detail_hak_akses as $pb){ 
                                        if($u->username == $pb->username){ 
                        ...
                        <td class="sorting_1" style="">
                            <a href="<?php echo site_url('admin/updateUser/'.$u->username); ?>" type="button" class="btn btn-white" title="Edit Data ">
                                <i class="material-icons">edit</i>
                            </a>
                            <a href="<?php echo site_url('admin/hapusUser/'.$u->username); ?>" onclick="return deletechecked();" type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus Data ">
