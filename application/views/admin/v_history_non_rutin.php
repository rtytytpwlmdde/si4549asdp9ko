...
?>
    ...
    <div class="page-header row no-gutters py-2">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
            <h3 class="page-title">Peminjaman Non Rutin</h3>
        </div>
    ...
    <div class="col ">
        ...
        <div class="row border-bottom  py-2">
            <div class="col-sm-3 text-center text-sm-left mb-0">
                <h6 class="m-0">Daftar Peminjaman</h6>
            </div>
        ...
        <div class=" pt-0">
            ...
            <div class="main-content-container ">
                ...
                <table class="table table-bordered table-hover " id="pegawai" >
                    ...
                    <tr>
                        <td><?php echo $no++ ?></td>
                        <td><?php echo $u->id_peminjaman ?></a></td>
                        <td><?php foreach ($mahasiswa as $a){if ($a->nim == $u->id_peminjam) :echo $a->nama;endif;}?>
                        ...
                        <td> 
                            <?php  foreach ($detail_peminjaman_non_rutin as $pb){ 
                        ...
                        <td class="sorting_1" style="">
                            ...
                            <a href="<?php echo site_url('admin/batal_peminjaman/'.$u->id_peminjaman); ?>"  class="mb-2 btn btn-sm btn-outline-warning mr-1" onclick="return batal();" title="Batalkan Peminjaman">
