...
?>
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a  href="<?php  echo base_url('admin/inputProdi'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
            ...
            <div class="main-content-container ">
                ...
                <td><?php echo $no++ ?></td>
                        ...
                        <td class="sorting_1" style="">
                            <a href="<?php echo site_url('admin/updateProdi/'.$u->id_prodi); ?>" type="button" class="btn btn-white" title="Edit Data Mahasiswa">
                                <i class="material-icons">edit</i>
                            </a>
                            <a href="<?php echo site_url('admin/hapusProdi/'.$u->id_prodi); ?>"  type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus Data Ruangan">
