...
?>
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-8 text-center text-sm-left mb-4 mb-sm-0">
            ...
            <h3 class="page-title">Rekap Jadwal Kuliah Pengganti</h3>
        </div>
        ...
        <div class="col-12 col-sm-2 text-center text-sm-left mb-4 mb-sm-0">
        ...
        <div class=" pt-0">
            ...
            <div class="main-content-container ">
                ...
                <tr>
                    ...
                    <th scope="col" class="border-0">ID Semester</th>
                    <th scope="col" class="border-0">Semester</th>
                    <th scope="col" class="border-0">Tanggal Mulai</th>
                    <th scope="col" class="border-0">Tanggal Selesai</th>
                ...
                <tbody>
                    ...
                    <td><a href="<?php echo site_url('admin/lihat_jadwal_plot/'.$u->id_semester); ?>"><?php echo $u->semester ?></a></td>
