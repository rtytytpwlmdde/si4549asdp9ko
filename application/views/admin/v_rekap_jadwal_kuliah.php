 ...
 <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a href="<?php  echo base_url('admin/tambah_tahun_ajaran'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
                  ...
                  <div class="card-body pt-0">
                    ...
                    <div class="main-content-container ">
                        <div class="" style="overflow-x:auto; ">
                           ...
                           <tr>
                               <td>1</td>
                               <td><a  href="<?php  echo base_url('admin/list_jadwal_kuliah'); ?>" >tahunajaran1</a></td>
                               <td>Ganjil</td>
                           ...
                           <tr>
                               <td>2</td>
                               <td><a  href="<?php  echo base_url('admin/list_jadwal_kuliah'); ?>" >tahunajaran2</a></td>
                               <td>Genap</td>
                           ...
                           <tr>
                               <td>3</td>
                               <td><a  href="<?php  echo base_url('admin/list_jadwal_kuliah'); ?>" >tahunajaran3</a></td>
                               <td>Ganjil</td>
                               <td>Maret 2017 - Juni 2018</td>
                               <td>
                               <a href="#" type="button" class="btn btn-white" title="Edit Ruangan">
