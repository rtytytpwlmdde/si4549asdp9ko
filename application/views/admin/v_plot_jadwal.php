...
?>
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <?php foreach($semester as $u){?> 
            <a  href="<?php  echo base_url('admin/inputJadwalKuliah/'.$u->id_semester); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
            ...
            <div class="main-content-container ">
                ...
                <td><?php echo $no++ ?></td>
                        ...
                        <td class="sorting_1" style="">
                            <a href="<?php echo site_url('admin/updateJadwalKuliah/'.$u->id_semester.'/'.$u->id_jadwal_kuliah); ?>" type="button" class="btn btn-white" title="Edit">
                                <i class="material-icons">edit</i>
                            </a>
                            <a href="<?php echo site_url('admin/hapusJadwalKuliah/'.$u->id_semester.'/'.$u->id_jadwal_kuliah); ?>"  type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus">
