...
?>
    ...
    <div class="page-header row no-gutters py-2">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
            <h3 class="page-title">Peminjaman Rutin</h3>
        </div>
                ...
                <table class="table table-bordered table-hover " id="pegawai" >
                    ...
                    <tr>
                        ...
                        <td class="sorting_1" style="">
                            ...
                            <a href="<?php echo site_url('admin/batal_peminjaman_rutin/'.$u->id_peminjaman); ?>"  class="mb-2 btn btn-sm btn-outline-warning mr-1" onclick="return batal();" title="Batalkan Peminjaman">
