...
<div class="main-content-container container-fluid px-4 mb-3">
                      ...
                      <div class="file-manager file-manager-cards">
                        <div class="card card-small mb-3">
                            ...
                            <div class="col-lg-3 mb-2 mb-lg-0">
                                <form method="post" action="<?php echo base_url("index.php/Import_mahasiswa/form"); ?>" enctype="multipart/form-data">
	...
	if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
		...
		echo "<form method='post' action='".base_url("index.php/import_mahasiswa/import")."'>";
		...
		<?php
			...
			echo "<a href='".base_url("index.php/import_mahasiswa/form")."'>Cancel</a>";
		}
