...
?>
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
            <span class="text-uppercase page-subtitle">Peminjaman Ruangan</span>
        ...
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a  href="<?php  echo base_url('admin/inputKategori'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
    ...
    <div class="col ">
        ...
        <div class="row border-bottom  py-2">
            <div class="col-sm-3 text-center text-sm-left mb-0">
                <h6 class="m-0">Tabel Data Jenis Barang</h6>
            </div>
        ...
        <div class=" pt-0">
            ...
            <div class="main-content-container ">
                ...
                <?php 
                    $no = 1;
                    foreach ($jenis_barang as $u){ 
                    ?>
                <tr>
                <td><?php echo $no++ ?></td>
                        <td><?php echo $u->id_jenis_barang ?></td>
                        <td><?php echo $u->jenis_barang ?></td>
						<td class="sorting_1" style="">
                            <a href="<?php echo site_url('admin/updateKategori/'.$u->id_jenis_barang); ?>" type="button" class="btn btn-white" title="Edit">
                                <i class="material-icons">edit</i>
                            </a>
                            <a href="<?php echo site_url('admin/hapusKategori/'.$u->id_jenis_barang); ?>"  type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus">
