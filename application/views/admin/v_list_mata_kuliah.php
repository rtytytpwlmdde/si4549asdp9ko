...
?>
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a  href="<?php  echo base_url('admin/inputMatkul'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
                ...
                <table class="table table-bordered table-hover " id="pegawai">
                    ...
                    <td><?php echo $no++ ?></td>
                            ...
                            <td class="sorting_1" style="">
                                <a href="<?php echo site_url('admin/updateMatkul/'.$u->kode_matkul); ?>" type="button" class="btn btn-white" title="Edit">
                                    <i class="material-icons">edit</i>
                                </a>
                                <a href="<?php echo site_url('admin/hapusMatkul/'.$u->kode_matkul); ?>"  type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus">
