...
?>
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div class="btn-group btn-group-sm btn-group-toggle d-inline-flex mb-4 mb-sm-0 mx-auto" role="group" aria-label="Page actions">
          <a href="<?php echo base_url('admin/data_dosen'); ?>" class="btn btn-white " title="Tampilkan hanya data dosen"> Dosen </a>
          <a href="<?php echo base_url('admin/data_pegawai'); ?>" class="btn btn-white " title="Tampilkan semua data pegawai"> Semua </a>
          <a href="<?php echo base_url('admin/data_staff'); ?>" class="btn btn-white active" title="Tampilkan hanya data staff"> Staff </a>
          <a href="<?php echo base_url('admin/data_non_homebase'); ?>" class="btn btn-white" title="Tampilkan hanya data Non Homebase"> Non Homebase </a>
        </div>
      </div>
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
        <div  style="float:right" >
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a  href="<?php  echo base_url('admin/tambah_pegawai'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
            ...
            <div class="main-content-container ">
                <div class="table-striped" style="overflow-x:auto; ">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="border-0">Nomor Telpon</th>
                        <th scope="col" class="border-0">Bagian</th>
                        <th scope="col" class="border-0">Sub Bagian</th>
                        <th scope="col" class="border-0">Urusan</th>
                        <th scope="col" class="border-0">Jabatan</th>
                    ...
                    <?php 
                        ...
                        <tr>
                            ...
                            <td class="sorting_1" style="">
                                ...
                                <a href="<?php echo site_url('admin/update_pegawai/'.$u->NIP); ?>" type="button" class="btn btn-white" title="Edit Data Pegawai">
                                    <i class="material-icons">edit</i>
                                </a>
                                <a href="<?php echo site_url('admin/hapusPegawai/'.$u->NIP); ?>" onclick="return deletechecked();" type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus Data Pegawai">
