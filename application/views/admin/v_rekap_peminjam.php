            ...
            <div class="col ">
                <div class="card card-small">
                  ...
                  <div class="row  py-2">
                    ...
                    <a href="<?php echo base_url('admin/rekap_peminjam_pegawai'); ?>" class="btn btn-white active"> Pegawai </a>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url(). 'admin/detail_peminjamM/'.$u->id_peminjam ?>">
					<?php 
                        echo $u->id_peminjam 
                    ?></a>
                    </td>
