 ...
 <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a href="<?php  echo base_url('admin/inputBarang'); ?>"  class="form-control btn btn-primary text-center text-white"  style="float:center">
                        ...
                        <table class="table table-bordered table-hover " id="pegawai">
                            ...
                            <td><?php echo $no++ ?></td>
                                    ...
                                    <td class="sorting_1" style="">
                                        <a href="<?php echo site_url('admin/updateBarang/'.$u->id_barang); ?>" type="button" class="btn btn-white" title="Edit">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <a href="<?php echo site_url('admin/hapusBarang/'.$u->id_barang); ?>" type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus">
