...
?>
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
        <form  action="<?php echo site_url('admin/PencariandetailM');?>"  method="get" style="float:right" >
                ...
                <div class="card card-small">
                  ...
                  <div class="row  py-2">
                     ...
                     <div class="col-12 col-sm-6 d-flex align-items-center">
						...
						<a href="<?php echo base_url('admin/perbulan_mahasiswa/'.$np); ?>"" class="btn btn-white">
                  ...
                  <div class="card-body pt-0">
                    ...
                    <div class="main-content-container ">
						...
						<td> 
									...
									<a href="<?php echo site_url('admin/peminjaman_rutin_Mahasiswa/'.$u->id_peminjaman); ?>" type="button" class="btn btn-white" title="Lihat Detail">
									<i class="material-icons">list_alt</i>
									</a>
									<?php }else if ($u->jenis_peminjaman == 'non rutin'){ ?>
									<a href="<?php echo site_url('admin/peminjaman_non_rutin_Mahasiswa/'.$u->id_peminjaman); ?>" type="button" class="btn btn-white" title="Lihat Detail">
									<i class="material-icons">list_alt</i>
									</a>
									<?php }else{?>
									<a href="<?php echo site_url('admin/peminjaman_sarana_prasarana_Mahasiswa/'.$u->id_peminjaman); ?>" type="button" class="btn btn-white" title="Lihat Detail">
									<i class="material-icons">list_alt</i>
									</a>
									<?php } ?>
									</td>
