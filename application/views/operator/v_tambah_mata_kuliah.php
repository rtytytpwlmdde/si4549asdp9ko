 ...
 <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
            ...
            <h3 class="page-title">Tambah Mata Kuliah</h3>
        </div>
              ...
              <div class="col-lg-8">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">Form Tambah Mata Kuliah</h6>
                  </div>
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-3">
                      <div class="row">
                        <div class="col">
                          <form action="<?php echo base_url(). 'operator/tambahMatkul'; ?>" method="POST">
                            <div class="form-group">
                              <label for="feInputAddress">Kode Mata Kuliah</label>
                              <input required name="kode_matkul" type="text"  class="form-control" id="feInputAddress" placeholder="kode mata kuliah"> 
                            </div>
                            <div class="form-group">
                               <label for="feInputAddress">Mata Kuliah</label>
                               <input required  name="nama_matkul" type="text" class="form-control" id="feInputAddress" placeholder="nama mata kuliah"> 
                            </div>
                            <div class="form-group">
