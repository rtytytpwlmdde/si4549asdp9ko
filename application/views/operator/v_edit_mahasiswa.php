 ...
 <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
            ...
            <h3 class="page-title">Update Data Mahasiswa</h3>
        </div>
              ...
              <div class="col-lg-8">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">Form Update Data Mahasiswa</h6>
                  </div>
                    ...
                    <li class="list-group-item p-3">
                      <div class="row">
                        ...
                        <?php foreach($mahasiswa as $u): ?>
                          <form action="<?php echo base_url(). 'operator/editMahasiswa'; ?>" method="POST">
                           ...
                           <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-accent">Update Mahasiswa</button>
                          </form>
                        <?php endforeach ?>
                        </div>
                      </div>
