...
?>
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
            ...
            <h3 class="page-title">Semua Jurusan</h3>
        </div>
        ...
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a  href="<?php  echo base_url('operator/inputJurusan'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
    ...
    <div class="col ">
        ...
        <div class="row border-bottom  py-2">
            <div class="col-sm-3 text-center text-sm-left mb-0">
                <h6 class="m-0">Tabel Data Jurusan</h6>
            </div>
            ...
            <div class="main-content-container ">
                ...
                <td><?php echo $no++ ?></td>
                        ...
                        <td class="sorting_1" style="">
                            <a href="<?php echo site_url('operator/updateJurusan/'.$u->id_jurusan); ?>" type="button" class="btn btn-white" title="Edit Data Mahasiswa">
                                <i class="material-icons">edit</i>
                            </a>
                            <a href="<?php echo site_url('operator/hapusJurusan/'.$u->id_jurusan); ?>"  type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus Data Ruangan">
