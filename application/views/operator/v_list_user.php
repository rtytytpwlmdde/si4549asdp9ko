...
?>
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div hidden class="btn-group btn-group-sm btn-group-toggle d-inline-flex mb-4 mb-sm-0 mx-auto" role="group" aria-label="Page actions">
          <a href="<?php echo base_url('operator/data_dosen'); ?>" class="btn btn-white" title="Tampilkan hanya data dosen"> Rutin </a>
          <a href="#" class="btn btn-white active" title="Tampilkan semua data pegawai"> Semua </a>
          <a href="<?php echo base_url('operator/data_staff'); ?>" class="btn btn-white" title="Tampilkan hanya data staff"> Non Rutin </a>
        </div>
      </div>
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
        <div  style="float:right" >
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a  href="<?php  echo base_url('operator/inputUser'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
            ...
            <div class="main-content-container ">
                ...
                <td><?php echo $no++ ?></td>
                        ...
                        <td class="sorting_1" style="">
                            <a href="<?php echo site_url('operator/updateUser/'.$u->username); ?>" type="button" class="btn btn-white" title="Edit Data ">
                                <i class="material-icons">edit</i>
                            </a>
                            <a href="<?php echo site_url('operator/hapusUser/'.$u->username); ?>" onclick="return deletechecked();" type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus Data ">
