        ...
        <select  name="bln1" class="custom-select custom-select-sm" style="max-width: 130px;">
            ...
            <div class="col ">
                <div class="card card-small">
                  ...
                  <div class="row  py-2">
                      <div class="col-sm-3 text-center text-sm-left mb-0">
                        <h6 class="m-0">Rekap Peminjam Pegawai</h6>
                      </div>
                    ...
                    <a href="#" class="btn btn-white active"> Pegawai </a>
                    <a href="<?php echo base_url('operator/rekap_peminjam'); ?>" class="btn btn-white"> Mahasiswa </a>
                    </div>
                    </div>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url(). 'operator/detail_peminjam/'.$u->id_dosen ?>">
					<?php 
                        echo $u->id_dosen 
                    ?></a>
                    </td>
