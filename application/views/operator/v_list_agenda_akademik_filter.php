    ...
    <!-- Page Header -->
     <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
            <span class="text-uppercase page-subtitle">Agenda Kegiatan Akademik</span>
            <h3 class="page-title"> Semua Kegiatan</h3>
        </div>
        <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
        <form action="<?php echo site_url('operator/filter_akademik');?>"  method="get" style="float:right" >
