 ...
 <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a href="<?php  echo base_url('operator/tambah_tahun_ajaran'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
                ...
                <div class="card card-small">
                  ...
                  <div class="row  py-2">
                      <div class="col-sm-3 text-center text-sm-left mb-0">
                        <h6 class="m-0">List Rekap Jadwal Kuliah</h6>
                      </div>
                        ...
                        <div class="" style="overflow-x:auto; ">
                            ...
                            <thead role="row" class="py-2 bg-light text-semibold border-bottom">
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Id Tahun Ajaran</th>
                                    <th scope="col" class="border-0">Semester</th>
                                    <th scope="col" class="border-0">Periode</th>
                                </tr>
                            </thead>
                           <tr>
                               <td>1</td>
                               <td><a  href="<?php  echo base_url('operator/list_jadwal_kuliah'); ?>" >tahunajaran1</a></td>
                               <td>Ganjil</td>
                               <td>Agustus 2018 - Januari 2019</td>
                               <td>
                           ...
                           <tr>
                               <td>2</td>
                               <td><a  href="<?php  echo base_url('operator/list_jadwal_kuliah'); ?>" >tahunajaran2</a></td>
                               <td>Genap</td>
                               <td>Maret 2017 - Juni 2018</td>
                               <td>
                           ...
                           <tr>
                               <td>3</td>
                               <td><a  href="<?php  echo base_url('operator/list_jadwal_kuliah'); ?>" >tahunajaran3</a></td>
                               <td>Ganjil</td>
                               <td>Maret 2017 - Juni 2018</td>
                               <td>
                               <a href="#" type="button" class="btn btn-white" title="Edit Ruangan">
