...
?>
    ...
    <div class="page-header row no-gutters py-4">
		...
		<span></spam>
            <h3 class="page-title">Data Peminjaman Barang Perbulan</h3>
        </div>
        ...
        <div class="card card-small">
            ...
            <table class="table mb-0 " id="pegawai" style="width:100%;">
                ...
                <tr>
                    ...
                    <td>
                    <a class="btn btn-sm btn-white" data-toggle="modal" data-target="#modal_edit<?php echo $id_barang;?><?php echo $bulan;?><?php echo $tahun;?>" title="Tampilkan surat tugas di bulan ini"> Open</a>	
                    </td>
                </tr>
                <?php } ?>
                </tbody>
    ...
    <div class="modal-content" style="min-width:80%; " >
        ...
        <div class="modal-body" >
            ...
            <table class="table table-sm borderless " style="text-align:left;">
                <tbody class="">
                    <tr>
                        <td class="">ID Barang</td>
                        <td class="">: <?php echo $i['id_barang']?></td>
                    </tr>
                    <tr>
                        <td class="">Nama Barang</td>
                        <td class="">: <?php echo $i['nama_barang']?></td>
                    </tr>
                </tbody>
            </table>
            </div>
		...
		<a type="button" class="btn btn-sm btn-primary" href="<?php echo site_url('operator/excelsuratbarang/'.$id_barang.'/'.$bulanModal.'/'.$thn->format('Y') ) ?>"><i class="fa fa-print"></i> Print</a>
