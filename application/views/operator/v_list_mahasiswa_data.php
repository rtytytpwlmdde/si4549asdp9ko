...
?>
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a  href="<?php  echo base_url('operator/inputMahasiwa'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
    ...
    <div class="row">
    <div class="col ">
	<form action="<?php echo base_url(). 'admin/data_mahasiswa'; ?>" method="POST">
            ...
            <div class="main-content-container ">
                ...
                <td><?php echo $no++ ?></td>
                        ...
                        <td class="sorting_1" style="">
                            <a href="<?php echo site_url('operator/updateMahasiswa/'.$u->nim); ?>" type="button" class="btn btn-white" title="Edit Data Mahasiswa">
                                <i class="material-icons">edit</i>
                            </a>
                            <a href="<?php echo site_url('operator/hapusMahasiswa/'.$u->nim); ?>" onclick="return deletechecked();" type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus Data Mahasiswa">
