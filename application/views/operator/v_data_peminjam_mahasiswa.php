...
?>
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
        <form  action="<?php echo site_url('operator/PencariandetailM');?>"  method="get" style="float:right" >
                ...
                <div class="card card-small">
                  ...
                  <div class="row  py-2">
                      <div class="col-sm-3 text-center text-sm-left mb-0">
                        <h6 class="m-0">Rekap Peminjaman Mahasiswa</h6>
                      </div>
                     ...
                     <div class="col-12 col-sm-6 d-flex align-items-center">
						...
						<a href="#" class="btn btn-white active"> <i class="material-icons">apps</i> Tampilkan Semua </a>
						<a href="<?php echo base_url('operator/perbulan_mahasiswa/'.$np); ?>"" class="btn btn-white">
						<i class="material-icons">date_range</i> Tampilkan Perbulan </a>
					</div>
					</div>
					<div class="col-sm-9 text-center text-sm-left mb-0">
						<h6 class="m-0"><?php echo $n?></h6>
						<p class="m-0"><?php echo $np?></p>
					</div>
                       <div class="col-sm-19  text-center text-sm-right mb-0">
                        <div id="export"></div>
                      </div>
                    </div>
                  </div>
                          ...
                          <tbody>
							<?php 
								...
								<tr>
									...
									<a href="<?php echo site_url('operator/peminjaman_rutin_Mahasiswa/'.$u->id_peminjaman); ?>" type="button" class="btn btn-white" title="Lihat Detail">
									<i class="material-icons">list_alt</i>
									</a>
									<?php }else if ($u->jenis_peminjaman == 'non rutin'){ ?>
									<a href="<?php echo site_url('operator/peminjaman_non_rutin_Mahasiswa/'.$u->id_peminjaman); ?>" type="button" class="btn btn-white" title="Lihat Detail">
									<i class="material-icons">list_alt</i>
									</a>
									<?php }else{?>
									<a href="<?php echo site_url('operator/peminjaman_sarana_prasarana_Mahasiswa/'.$u->id_peminjaman); ?>" type="button" class="btn btn-white" title="Lihat Detail">
									<i class="material-icons">list_alt</i>
									</a>
									<?php } ?>
									</td>
