    ...
    <div class="page-header row no-gutters py-4">
        ...
        <select  name="bln1" class="custom-select custom-select-sm" style="max-width: 130px;">
            ...
            <div class="col ">
                <div class="card card-small">
                  ...
                  <div class="row  py-2">
                      <div class="col-sm-3 text-center text-sm-left mb-0">
                        <h6 class="m-0">Rekap Peminjam Mahasiswa</h6>
                      </div>
                    ...
                    <a href="<?php echo base_url('operator/rekap_peminjam_pegawai'); ?>" class="btn btn-white active"> Pegawai </a>
                ...
                <?php 
                    $no = 1;
                    foreach ($rekap_peminjam as $u){ 
                    ?>
                <tr>
                    <td scope="row"><?php echo $no++ ?></td>
                    <td><a href="<?php echo base_url(). 'operator/detail_peminjamM/'.$u->id_peminjam ?>">
					<?php 
                        echo $u->id_peminjam 
                    ?></a>
                    </td>
                    ...
                    <td><?php echo $u->jumPeminjaman ?></td>
                </tr>
                <?php } ?>
                </tbody>
                            </table>
