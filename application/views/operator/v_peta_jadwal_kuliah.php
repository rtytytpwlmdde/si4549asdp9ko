...
<div class="main-content-container container-fluid">
                  ...
                  <div class="page-header row no-gutters ">
                    ...
                    <form action="<?php echo site_url('operator/peta_jadwal_kuliah_filter');?>"  method="get" style="float:right" >
                                        ...
                                        if($u->hari == $day){
                                            if($u->id_ruangan == $ruang) { 
                                              ...
                                              <div class="collapse" id="collapse<?php echo $u->id_jadwal_kuliah ?>">
                                                  <p>
                                                      <a href="<?php echo site_url('operator/editJadwalKuliah/'.$u->id_semester.'/'.$u->id_jadwal_kuliah); ?>" type="button" class="btn btn-white" title="Edit">
                                                          <i class="material-icons text-success">edit</i>
                                                      </a>
                                                      <a href="<?php echo site_url('operator/hapusJadwalKuliahHasilPlot/'.$u->id_semester.'/'.$u->id_jadwal_kuliah); ?>" type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus">
                                          ...
                                          <?php 
                                            if($result == 0){
                                                ...
                                                $dt_waktu = $waktu;
                                                ?> <div>
                                                <a href="<?php echo site_url('operator/tambahJadwal/'.$u->id_semester.'/'.$dt_ruang.'/'.$dt_waktu.'/'.$h->hari); ?>"  title="Tambah Jadwal">
