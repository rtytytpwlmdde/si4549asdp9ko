 ...
 <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a href="<?php  echo base_url('admin/tambah_sarana_prasarana'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
                        ...
                        <div class="table-striped" style="overflow-x:auto; ">
                            ...
                            <thead role="row" class="py-2 bg-light text-semibold border-bottom">
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Kode Barang</th>
                           ...
                           <tr>
                               ...
                               <td>LCD</td>
                               <td>
                               <a  href="#" type="button" class="btn btn-white" title="Edit Barang">
                                    <i class="material-icons">edit</i>
                                </a>
                                <a  href="#" type="button" class="btn btn-white" onclick="return deletechecked();" title="hapus Barang">
                           ...
                           <tr>
                               ...
                               <td>Laptop apel</td>
                               <td>
                               <a title="update Barang" href="#" type="button" class="btn btn-white" title="Edit Barang">
                                    <i class="material-icons">edit</i>
                                </a>
                                <a href="#" type="button" class="btn btn-white" onclick="return deletechecked();" title="hapus Barang">
                                    <i class="material-icons">delete</i>
