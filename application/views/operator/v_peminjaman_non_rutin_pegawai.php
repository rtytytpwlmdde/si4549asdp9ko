                        ...
                        <div class="table-striped" style="overflow-x:auto; ">
                            ...
                            <thead role="row" class="py-2 bg-light text-semibold border-bottom">
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Nama Penyelenggara</th>
                                    <th scope="col" class="border-0">Nama Agenda</th>
                                    <th scope="col" class="border-0">Ruangan </th>
                                    <th scope="col" class="border-0">Jam Pemakaian</th>
                                    <th scope="col" class="border-0">Status</th>
									<th scope="col" class="border-0">Jenis Peminjaman</th>
                                </tr>
                            </thead>
							<tbody>
							<?php 
								...
								<tr>
									...
									<?php 
                                    foreach ($detail_peminjaman_non_rutin as $a){ 
                                    } ?>
