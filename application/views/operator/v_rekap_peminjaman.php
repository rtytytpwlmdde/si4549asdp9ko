 ...
 <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
		...
		<div class="col-12 col-sm-0 text-center text-sm-right mb-4 mb-sm-6">
                <div class="btn-group " >
                    <a href="<?php echo base_url('operator/peminjaman_rutin_filter/rutin'); ?>" class="btn btn-warning text-white"> Rutin </a>
                    <a href="<?php echo base_url('operator/peminjaman_non_rutin_filter/'); ?>" class="btn btn-success text-white">Non Kelas </a>
                     <a href="<?php echo base_url('operator/peminjaman_rutin_filter/barang'); ?>" class="btn btn-danger text-white">Sarana dan Prasarana </a>
                </div>
            </div>
        <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
