                ...
                <div class="card card-small mb-4">
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-3">
                      <div class="row">
                        <div class="col">
                          <form action="<?php echo base_url(). 'operator/pass'; ?>" method="POST">
                          
                          <?php foreach($pegawai as $u){ ?>
                            <div class="form-group">
                              <label for="feInputAddress">NIP</label>
                              <input required pattern="[0-9]{5,25}" title="Gunakan Angka, 5-25 karakter" name="NIP" type="text" value= "<?php echo $u->NIP ?>" class="form-control" id="feInputAddress" > 
                            </div>
                            <div class="form-group">
                ...
                <div class="card card-small mb-4 pt-3">
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-4">
                      ...
                      <span>1. Password pegawai yang diriset akan diambil berdasarkan 6 terakhir dari NIP.</span><br>
                      <span>2. Pastikan nip pegawai tidak salah saat reset password.</span><br>
                    </li>
                  </ul>
                </div>
              </div>
