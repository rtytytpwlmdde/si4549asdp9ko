...
?>
    ...
    <div class="page-header row no-gutters py-4">
		...
		<span></spam>
            <h3 class="page-title">Data Peminjaman Mahasiswa Perbulan</h3>
        </div>
        <div class="col-12 col-sm-4 d-flex align-items-center">
            <div class="btn-group btn-group-sm btn-group-toggle d-inline-flex mb-4 mb-sm-0 mx-auto" role="group" aria-label="Page actions">
                <a href="<?php echo base_url('operator/detail_peminjamM/'.$np); ?>" class="btn btn-white "> <i class="material-icons">apps</i> Tampilkan Semua </a>
        ...
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
        <form action="<?php echo site_url('operator/perbulan_mahasiswa_filter');?>" method="get" style="float:right">
        ...
        <div class="card card-small">
            ...
            <table class="table mb-0 " id="pegawai" style="width:100%;">
                ...
                <tr>
                    ...
                    <td>
                    <a class="btn btn-sm btn-white" data-toggle="modal" data-target="#modal_edit<?php echo $id_peminjam;?><?php echo $bulan;?><?php echo $tahun;?>" title="Tampilkan surat tugas di bulan ini"> Open</a>	
                    </td>
                </tr>
                <?php } ?>
                </tbody>
...
<div class="modal fade " data-backdrop="true" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" id="modal_edit<?php echo $id_peminjam;?><?php echo $bulanModal;?><?php echo $tahunModal;?>">
  <div class="modal-dialog full-screen modal-dialog-centered " role="document"  style="min-width:80%;">
    <div class="modal-content" style="min-width:80%; " >
		...
		<a type="button" class="btn btn-sm btn-primary" href="<?php echo site_url('operator/excelsuratmahasiswaperbulan/'.$id_peminjam.'/'.$bulanModal.'/'.$thn->format('Y') ) ?>"><i class="fa fa-print"></i> Print</a>
       </div>
    </div>
  </div>
</div>
...
<div class="modal fade " data-backdrop="true" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" id="modal_surat<?php echo $nosuratModal?>">
  <div class="modal-dialog  modal-dialog-centered " role="document" >
    <div class="modal-content" style="min-width:50%">
        ...
        <p class="modal-title" id="exampleModalLongTitle">Surat Tugas <?php echo $nosuratModal ?> Tidak Mempunyai Surat Online</p>
            </div>
        </div>
        <div class="modal-footer">
        <a type="button" class="btn btn-sm btn-white" data-dismiss="modal">Close</a>
