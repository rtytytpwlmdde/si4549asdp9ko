            ...
            <div class="col-lg-8 col-md-12 col-sm-12 mb-4">
                <div class="card card-small">
                  ...
                  <div class="row border-bottom py-2 bg-light">
                      ...
                      <form  method="post" action="<?php echo site_url('operator/indeks');?>" style="float:right" >
                  ...
                  <div class="card-body p-0 d-flex ">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase text-success py-2">Mahasiswa Peminjam Terbanyak</span>
                        <div class="table-responsive table-striped py-2">
                          <table class="table mb-0  text-left">
							...
							<th scope="col"><a href="rekap_peminjam" class="card-post__category badge badge-success">View All<i class="material-icons">trending_up</i></a></th>
                            </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-lg col-md-6 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase text-primary py-2">Dosen Peminjam Terbanyak</span>
                        <div class="table-responsive table-striped py-2">
					...
					<span class="stats-small__label text-uppercase text-primary py-2"> <a href="rekap_peminjam_pegawai" class="card-post__category badge badge-info">View All<i class="material-icons">trending_up</i></a></span>
              ...
              <div class="col-lg col-md-6 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase text-warning py-2">Barang Dipinjam Terbanyak</span>
                        <div class="table-responsive table-striped py-2">
                        <table class="table mb-0 responsive-table text-left ">
                      <thead class="bg-light">
                        <tr>
					...
					<span class="stats-small__label text-uppercase text-warning py-2"> <a href="rekap_peminjaman_barang" class="card-post__category badge badge-warning">View All<i class="material-icons">trending_up</i></a></span>
