...
?>
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
            <span class="text-uppercase page-subtitle">Semester</span>
            <h3 class="page-title">Semua Semester</h3>
        </div>
        ...
        <div id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
            <a  href="<?php  echo base_url('operator/inputSemester'); ?>" type="submit" class="form-control btn btn-primary text-center text-white"  style="float:center">
    ...
    <div class="col ">
        ...
        <div class="row border-bottom  py-2">
            <div class="col-sm-3 text-center text-sm-left mb-0">
                <h6 class="m-0">Tabel Data Semester</h6>
            </div>
        ...
        <div class=" pt-0">
            ...
            <div class="main-content-container ">
                ...
                <tr>
                    ...
                    <th scope="col" class="">Tanggal Mulai</th>
                    <th scope="col" class="">Tanggal Selesai</th>
                    <th scope="col" class="">Status</th>
                    <th scope="col" class="">Plot Jadwal</th>
                ...
                <tbody>
                    ...
                    <td><a href="<?php echo site_url('operator/jadwal_kuliah/'.$u->id_semester); ?>"><?php echo $u->semester ?></a></td>
                    ...
                    <td class="sorting_1" style="">
                        <a href="<?php echo site_url('operator/updateSemester/'.$u->id_semester); ?>" type="button" class="btn btn-white" title="Edit">
                            <i class="material-icons">edit</i>
                        </a>
                        <a href="<?php echo site_url('operator/hapusSemester/'.$u->id_semester); ?>" type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus">
...
function plot()
    {
        if(confirm("Perhatian! Jadwal lama akan langsung dihapus saat melakukan ploting jadwal baru!"))
        {
            return true;
        }
        else
