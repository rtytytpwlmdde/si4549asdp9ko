                        ...
                        <div class="card card-small mb-3">
							...
							<?php
								if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
									...
									echo "
									<form method='post' action='".base_url("index.php/Import_ruangan/import")."'>
									...
									foreach($sheet as $row){ 
										...
										$id_ruangan = $row['A']; // Ambil data NIS
										$ruangan = $row['B']; // Ambil data nama
										$jenis_ruangan = $row['C']; // Ambil data jenis kelamin
										$status = $row['D']; // Ambil data alamat
										// Cek jika semua data tidak diisi
										if(empty($id_ruangan) && empty($ruangan) && empty($jenis_ruangan) && empty($status))
										...
										if($numrow > 1){
											...
											$nis_td = ( ! empty($id_ruangan))? "" : " style='background: #E07171;'"; // Jika NIS kosong, beri warna merah
											$nama_td = ( ! empty($ruangan))? "" : " style='background: #E07171;'"; // Jika Nama kosong, beri warna merah
											$jk_td = ( ! empty($jenis_ruangan))? "" : " style='background: #E07171;'"; // Jika Jenis Kelamin kosong, beri warna merah
											$alamat_td = ( ! empty($status))? "" : " style='background: #E07171;'"; // Jika Alamat kosong, beri warna merah
											...
											echo "<tr>";
											echo "<td".$nis_td.">".$id_ruangan."</td>";
											echo "<td".$nama_td.">".$ruangan."</td>";
											echo "<td".$jk_td.">".$jenis_ruangan."</td>";
											echo "<td".$alamat_td.">".$status."</td>";
											echo "</tr>";
										}
									...
									<?php
										...
										echo "<a href='".base_url("index.php/import_ruangan/form")."'>Cancel</a>";
									}
									echo "</form>";
								}
								?>
                        ...
                        <div class='card-body p-0'>
                          <ul class="list-group list-group-flush">
                            <li class="list-group-item p-3">
                              <span class=""> Format nama file yang di import  <strong>  formatRuangan.xls</strong></span>
                            </li>
                            
                            <li class="list-group-item ">
                              <span class=""> Contoh format excel dapat di unduh pada link berikut </span> <a class="" href="<?php echo base_url("excel/formatRuangan.xlsx"); ?>"><i class="material-icons">attach_file</i>File</a>
                            </li>
                          </ul>
                        </div>
                      </div>
