                    ...
                    <div class="main-content-container ">
                        <div class="table-striped" style="overflow-x:auto; ">
                           ...
                           <tr>
                               ...
                               <td>
                                <div class="btn-group btn-group-sm" >
                                    <a  href="#"  class="btn btn-sm btn-outline-success" title="Setuju Permintaan Peminjaman">
                                        <i class="material-icons">check</i>
                                    </a>
                                    <a href="#"  class="btn btn-sm btn-outline-warning"  title="Pending Permintaan Peminjaman">
                                        <i class="material-icons">refresh</i>
                                    </a>   
                                    <a href="#"  class="btn btn-sm btn-outline-danger" title="Tolak Permintaan Peminjaman">
                           ...
                           <tr>
                               ...
                               <td>E13</td>
                               <td>07:00 - 09:30</td>
                               <td class="text-success">Setuju</td>
                               <td>
                               <div class="btn-group btn-group-sm" >
                                    <a  href="#"  class="btn btn-sm btn-outline-success" title="Setuju Permintaan Peminjaman">
                                        <i class="material-icons">check</i>
