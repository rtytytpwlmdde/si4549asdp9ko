...
?>
    ...
    <div class="page-header row no-gutters py-4">
        ...
        <div class="btn-group btn-group-sm btn-group-toggle d-inline-flex mb-4 mb-sm-0 mx-auto" role="group" aria-label="Page actions">
          ...
          <a href="<?php echo base_url('operator/data_staff'); ?>" class="btn btn-white active" title="Tampilkan hanya data staff"> Staff </a>
          <a href="<?php echo base_url('operator/data_non_homebase'); ?>" class="btn btn-white" title="Tampilkan hanya data Non Homebase"> Non Homebase </a>
        </div>
      </div>
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
