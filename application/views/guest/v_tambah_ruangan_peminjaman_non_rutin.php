...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <div class="mb-3">
        <div class="">
            <p class="mb-4">Data Peminjaman Non Rutins </p>
            <div class=" alert alert-accent alert-dismissible fade show mb-3" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                </button>
                <strong class="text-white">Perhatian! Tambahkan ruangan yang akan digunakan selama status peminjaman masih "pending" </strong>   <br>
                <strong class="text-white">Tekan tombol <info class="text-warning">Selesai</info> setelah semua ruangan telah di input </strong>   
            </div>
            <div class="main-content-container ">
                ...
                <tr>
                    ...
                    <th scope="col" class="border-0">Catatans</th>
                </tr>
                </thead>
                <tbody>
                <?php 
            ...
            <div class='card-body p-0'>
                ...
                <div class="table-striped" style="overflow-x:auto; ">
                    ...
                    <td><?php echo $no++ ?></td>
                            ...
                            <?php 
                            if($r->status == "pending"){ ?>
                                <a href="<?php echo site_url('dosen/hapus_ruangan_peminjaman_non_rutin/'.$u->id_peminjaman_non_rutin."/".$u->id_ruangan); ?>"  type="button" class="btn btn-white" onclick="return deletechecked();" title="Hapus">
    ...
    <div class="col-lg-4 col-md-12">
        ...
        <div class='card-body p-0'>
            ...
            <form action="<?php echo base_url(). 'dosen/tambahRuanganPeminjamanNonRutin/'; ?>" method="post">
            ...
            <label for="feInputAddress">Ruangan</label>
                ...
                <?php 
                    foreach ($ruangan as $a){?>
                            <option value="<?php echo $a->id_ruangan;?>"><?php echo $a->ruangan;?></option>
                        <?php }  ?>
            </select><br>
            <?php 
            if($u->status == "pending"){ ?>
            ...
            <?php }else if($no != 1){?>
            <a  href="<?php echo site_url('dosen/ubah_status_peminjaman_non_rutin/1/'.$u->id_peminjaman_non_rutin.'/'.$u->id_peminjam);?>" class="mb-2 btn btn-sm btn-primary mr-1"><info class="text-warning">Selesai</info></a>
            <?php }?>
            <?php }else{ ?>
                <button disabled class="mb-2 btn btn-outline-primary mr-2">Tambah Ruangan</button>
                <a  hidden href="" class="mb-2 btn btn-sm btn-primary mr-1"><info class="text-warning">Selesai <?php echo $no; ?></info></a>           
            <?php }
            ?>
            </form>
            <?php endforeach; ?>
