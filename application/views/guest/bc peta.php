...
<div class="main-content-container container-fluid">
                  ...
                  <div class="page-header row no-gutters ">
                    ...
                    <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
                    <form action="<?php echo site_url('guest/filter_jadwal_plot');?>"  method="get" style="float:right" >
                    ...
                    <select   name="id_fiter_by" id="singleSelectDD"  onchange="singleSelectChangeValue()" class="id_fiter_by custom-select custom-select-sm" style="min-width: 200px;">
                      ...
                      <input  name="date" type="date" class="custom-select custom-select-sm" style="min-width: 200px;">
                        ...
                        <a class="input-group-append form-control btn btn-primary" data-toggle="collapse" href="#collapseExample" aria-controls="collapseExample">
                          <i class="material-icons">arrow_downward</i>
                      </a>
                    </div>
                    </form>
                    </div>
                        <input  type="text" id="myInputs" onkeyup="myFunction()" >
                </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class=" bg-white py-2  mb-4">
                        ...
                        <table class="" style="overflow-x:auto; width: 100%; padding:0; margin:0;" id="">
                                          ...
                                          foreach ($jadwal_kuliah as $u){
                                            ...
                                            style=""
                                              ...
                                              <?php }else {?>
                                                class="col2 col-merahhitam text-center p-3"
                                              <?php }?>>
                                                <div class="asd"><?php foreach ($mata_kuliah as $a){if ($a->kode_matkul == $u->kode_matkul) :?></div>
                                                ...
                                                <p><?php echo "prodi".$u->id_prodi."prodi"; ?></p>
                                            <?php }else{
