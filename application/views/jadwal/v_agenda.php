...
?>
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
            ...
            <h3 class="page-title">List Agenda</h3>
        </div>
    ...
    <div class="col ">
        ...
        <div class="row border-bottom  py-2">
            <div class="col-sm-3 text-center text-sm-left mb-0">
                <h6 class="m-0"> <?php  echo date("l d M Y") . "<br>";?></h6>
            </div>
        ...
        <div class=" pt-0">
            ...
            <div class="main-content-container ">
                ...
                <table class="table mb-0 " id="pegawai">
                    ...
                    <tr>
                        <th scope="col" class="border-0"><?php $u->tanggal_pemakaian?></th>
                    ...
                    <tbody>
                    <tr>
                        <td><?php echo $u->jam_mulai_agenda ?> - <?php echo $u->jam_selesai_agenda ?></td>
                        <td><?php echo $u->jam_selesai_agenda ?></td>
