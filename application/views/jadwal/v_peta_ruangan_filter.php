<div class="main-content-container container-fluid">
                  ...
                  <div class="page-header row no-gutters py-4">
                    <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
                        ...
                        <h3 class="page-title">Ploting Jadwal Per Semester</h3>
                    </div>
                    <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
                    ...
                    <form action="<?php echo site_url('jadwal/peta_jadwal_kuliah_filter');?>"  method="get" style="float:right" >
                      <div  id="transaction-history-date-range" class="input-daterange input-group  input-group-sm ml-auto">
                        <select required name="semester" class="custom-select custom-select-sm" style="min-width: 200px;">
                                      ...
                                      <?php foreach ($jadwal_kuliah as $u){ 
                                        ...
                                        >
                                                <div  data-toggle="collapse" data-target="#collapse<?php echo $u->id_jadwal_kuliah ?>" aria-expanded="false" aria-controls="collapseExample">
                                                  ...
                                                  <?php endif;}  ?>
                                                  <h6 class="text-white" style="font-size:12px;"><?php foreach ($prodi as $a){if ($a->id_prodi == $u->id_prodi) :echo substr($a->prodi,0,40);endif;}  ?><br>
                                                  <h6 class="text-white" style="font-size:12px;"><?php foreach ($ruangan as $a){if ($a->id_ruangan == $u->id_ruangan) :echo substr($a->ruangan,0,40);endif;}  ?><br>
                                                  <a><?php echo $u->id_dosen;  ?><a>                   
                                      ...
                                      <th style="max-width:120px;" class="py-2">
                                        <?php foreach ($jadwal_kuliah as $u){ 
                                          ...
                                          >
                                              <div  data-toggle="collapse" data-target="#collapse<?php echo $u->id_jadwal_kuliah ?>" aria-expanded="false" aria-controls="collapseExample">
                                                  <div class=""><?php foreach ($mata_kuliah as $a){if ($a->kode_matkul == $u->kode_matkul) :echo $a->nama_matkul;?></div>
                                                    <div style="color: rgba(0, 0, 0, 0.02); font-size: 0.015pt;"><?php echo "matkul".$u->nama_matkul."matkul";  ?></div>
                                                  <?php endif;}  ?>
                                                  <div class=""><?php foreach ($mata_kuliah as $a){if ($a->kode_matkul == $u->kode_matkul) :echo $a->nama_matkul;?></div>
                                                  <div style="color: rgba(0, 0, 0, 0.02); font-size: 0.015pt;"><?php echo "matkul".$u->kode_matkul."matkul";  ?></div>
                                                  <?php endif;}  ?>
                                  ...
                                  <tr>
                                      ...
                                      <th style="max-width:120px;" class="py-2">
                                        <?php foreach ($jadwal_kuliah as $u){ 
                                          ...
                                          >
                                              <div  data-toggle="collapse" data-target="#collapse<?php echo $u->id_jadwal_kuliah ?>" aria-expanded="false" aria-controls="collapseExample">
                                                  <div class=""><?php foreach ($mata_kuliah as $a){if ($a->kode_matkul == $u->nama_matkul) :echo $a->nama_matkul;?></div>
                                                    <div style="color: rgba(0, 0, 0, 0.02); font-size: 0.015pt;"><?php echo "matkul".$u->nama_matkul."matkul";  ?></div>
                                                  <?php endif;}  ?>
                                                  <h6 class="text-white" style="font-size:12px;"><?php foreach ($prodi as $a){if ($a->id_prodi == $u->id_prodi) :echo substr($a->prodi,0,40);endif;}  ?><br>
                                                  <h6 class="text-white" style="font-size:12px;"><?php foreach ($ruangan as $a){if ($a->id_ruangan == $u->id_ruangan) :echo substr($a->ruangan,0,40);endif;}  ?><br>
                ...
                <div class=" mb-4">
                    ...
                    <div class="form-group col-md-8">
                        <label for="feInputAddress">Mata Kuliah</label>
                           <input  class="form-control" list ="kode_matkul" name="kode_matkul" id="feInputState" type="text" value="<?php echo $p->kode_matkul ?>">
                                <datalist id = "kode_matkul">
								<?php foreach ($mata_kuliah as $a) : ?>
                                <option value="<?= $a->kode_matkul; ?> - <?php $a->nama_matkul;?>"
                    ...
                    <div class="form-group">
                        <label for="feInputAddress">Dosen</label>
                            <input  list="id_dosen" name="id_dosen" id="feInputState" class="form-control" type="text" value="<?php echo $p->id_dosen ?>">
                            <datalist id="id_dosen">
                        ...
                        <div class="col">
                          ...
                          <div class="form-group col-md-4">
                                ...
                                <select hidden  name="hari" id="feInputState" class="form-control">
                                    <option value="Monday" <?php echo ($x=='1')?'selected="selected"':''; ?>>Senin</option>
                                    <option value="Tuesday" <?php echo ($x=='2')?'selected="selected"':''; ?>>Selasa</option>
                                    <option value="Wednesday" <?php echo ($x=='3')?'selected="selected"':''; ?>>Rabu</option>
                                    <option value="Thursday" <?php echo ($x=='4')?'selected="selected"':''; ?>>Kamis</option>
                                    <option value="Friday" <?php echo ($x=='5')?'selected="selected"':''; ?>>Jumat</option>
                                    <option value="Saturday" <?php echo ($x=='6')?'selected="selected"':''; ?>>Sabtu</option>
                                    <option value="Sunday" <?php echo ($x=='7')?'selected="selected"':''; ?>>Minggu</option>
                                </select>
							...
							<div class="form-group">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="form-control" list ="matkul" name="kode_matkul" id="feInputState" type="text" placeholder="Ketik Kode Matkul/ Nama">
                                        <datalist id = "matkul">
                                        <?php foreach($mata_kuliah as $u){ ?>
                                        <option value="<?php echo $u->kode_matkul ?> - <?php echo $u->nama_matkul ?>"> <?php echo $u->kode_matkul ?></option>
                                        <?php } ?>
                                        </datalist>
                                    </div>
                            </div>
							<div class="form-group">
                                    <label for="feInputAddress">Dosen</label>
                                    <div class="uk-form-controls">
                                        <input class="form-control" list ="NIP" name="id_dosen" id="feInputState" type="text" placeholder="Ketik NIP/ Nama">
                                        <datalist id = "NIP">
                                        <?php foreach($dosen as $u){ ?>
                                        <option value="<?php echo $u->NIP ?> - <?php echo $u->Nama ?>"> <?php echo $u->NIP ?></option>
                                        <?php } ?>
                                        </datalist>
                                    </div>
                            </div>
