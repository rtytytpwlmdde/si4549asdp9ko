                    ...
                    <li class="list-group-item p-3">
                      <div class="row">
                        ...
                        <?php foreach($pegawai as $u): ?>
                          <form action="<?php echo base_url(). 'dosen/editPegawai'; ?>" method="POST">
                            ...
                            <div class="form-row"> 
                                ...
                                <label for="feInputAddress">Status</label>
                                    <select disabled required  name="Status" id="feInputState" class="form-control">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input disabled required  name="Sub_Bagian" type="text" list="Sub_Bagian" class="form-control" id="feInputAddress" value="<?php echo $u->Sub_Bagian ?>"> 
                            ...
                            <div class="form-group">
                              <label for="feInputAddress">Jabatan</label>
                                <select disabled required  name="jabatan" id="feInputState" class="form-control">
                            ...
                            <div class="form-group">
                              <label for="feInputAddress">Status aktif</label>
                                <select disabled required  name="stat" id="feInputState" class="form-control">
