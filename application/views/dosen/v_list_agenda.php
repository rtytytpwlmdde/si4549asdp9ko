...
?>
    ...
    <div class="page-header row   py-1">
            ...
            <h3 class="page-title"> AGENDA KEGIATAN</h3>
            </div>
                          ...
                          <td>asd</td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                    <div class="">
                                        <span style="font-size:27px; color:#5a8eef;"><?php echo $u->nama_agenda ?></span><br>
                                        <span>
                                        <?php 
                                        ...
                                        ?>
                                        </span><i class="tiny material-icons text-primary">fiber_manual_record</i>
                                        <span><?php echo ($u->jam_selesai_peminjaman - $u->jam_mulai_peminjaman)?>h </span><i class="tiny material-icons text-primary">fiber_manual_record</i>
                                        <span>Lokasi : <?php 
                                        ...
                                        <span>Penyelenggara :<?php foreach ($penyelenggara as $a){if ($a->id_penyelenggara == $u->penyelenggara) :echo $a->penyelenggara;endif;}  ?></span><br>
										<span>Keterangan : <?php echo $u->keterangan ?> </span>
                                    </div>
                                    </td>
                                </tr>
                    <?php } ?>
