              ...
              <div class="col-lg-4">
                <div class="card card-small mb-4 pt-3">
                  <div class="card-header border-bottom text-center">
					...
					<a href="<?php echo site_url('dosen/update_pegawai/'.$u->NIP); ?>" type="button" class="btn btn-white" title="Edit Data Mahasiswa">
                      ...
                      <div class="row">
                        ...
                        <?php foreach($user as $u): ?>
                          <form action="<?php echo base_url(). 'dosen/update_password'; ?>" method="POST">
                            ...
                            <input hidden type="text" name="username" class="form-control" id="feFirstName" value="<?php echo $u->NIP ?>"> 
