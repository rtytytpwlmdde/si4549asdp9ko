...
class Import_mahasiswa_op extends CI_Controller {
	...
	public function index(){
		$data['main_view'] = 'operator/view_mahasiswa';
	...
	public function form(){
		...
		$data['main_view'] = 'operator/form_mahasiswa';
		$this->load->view('template/template_operator', $data);
	}
	...
	public function import(){
		...
		redirect("Import_mahasiswa_op"); // Redirect ke halaman awal (ke controller siswa fungsi index)
	}
}
